...
DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::DIALOG_BOARD_RENUM_CONTINUEABORT_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	// Connect Events
	m_Continue->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::ErrorContinue ), NULL, this );
	m_Abort->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::ErrorAbort ), NULL, this );
}

DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::~DIALOG_BOARD_RENUM_CONTINUEABORT_BASE()
{
	// Disconnect Events
	m_Continue->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::ErrorContinue ), NULL, this );
	m_Abort->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_CONTINUEABORT_BASE::ErrorAbort ), NULL, this );

}

DIALOG_BOARD_RENUM_ABORT_BASE::DIALOG_BOARD_RENUM_ABORT_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	this->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );
	...
	// Connect Events
	m_Continue->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_ABORT_BASE::ErrorContinue ), NULL, this );
}

DIALOG_BOARD_RENUM_ABORT_BASE::~DIALOG_BOARD_RENUM_ABORT_BASE()
{
	// Disconnect Events
	m_Continue->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_BOARD_RENUM_ABORT_BASE::ErrorContinue ), NULL, this );
